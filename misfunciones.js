...
/**
 * Cálculo de riesgo según modelo probabilístico de Gail.
 * @method Función para cargar datos del cálculo de riesgo en segunda web;
 * return mostrar los respuestas ingresadas
 */
function cargarForm() {
 ...
 * @method Funciónes para evaluar el calculo de riesgo relativo;
 */
